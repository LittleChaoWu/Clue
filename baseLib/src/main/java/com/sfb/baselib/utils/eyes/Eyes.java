package com.sfb.baselib.utils.eyes;
...
public class Eyes {
    ...
    //背景为整个颜色的 标题栏黑色字体
    public static void translucentStatusBarBlack(Activity activity) {
        translucentStatusBar(activity, true);
    }

    // 标题栏黑色字体
    public static void translucentStatusBlackText(Activity activity) {
        MIUISetStatusBarLightMode(activity, true);
        FlymeSetStatusBarLightMode(activity, true);
    }

    public static void translucentStatusBar(Activity activity, boolean isBlack) {
        if (isBlack) {
            MIUISetStatusBarLightMode(activity, true);
            FlymeSetStatusBarLightMode(activity, true);
        }
