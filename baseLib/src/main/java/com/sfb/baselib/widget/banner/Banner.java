package com.sfb.baselib.widget.banner;
...
import com.sfb.baselib.widget.banner.adapter.BannerAdapter;
import com.sfb.baselib.widget.banner.config.BannerConfig;
import com.sfb.baselib.widget.banner.config.IndicatorConfig;
import com.sfb.baselib.widget.banner.indicator.Indicator;
...
import com.sfb.baselib.widget.banner.transformer.MZScaleInTransformer;
import com.sfb.baselib.widget.banner.transformer.ScaleInTransformer;
import com.sfb.baselib.widget.banner.utils.BannerLifecycleObserver;
import com.sfb.baselib.widget.banner.utils.BannerLifecycleObserverAdapter;
import com.sfb.baselib.widget.banner.utils.BannerUtils;
import com.sfb.baselib.widget.banner.utils.ScrollSpeedManger;
...
public class Banner<T extends BaseBean, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
     ...
     */
    public void setDatas(List<T> datas, boolean takeUpSpace) {
        if (getAdapter() != null) {
