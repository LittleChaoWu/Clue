 ...
 */
class CornerUtils {
    static Drawable cornerDrawable(final int bgColor, float cornerradius) {
     ...
     */
    static StateListDrawable listItemSelector(float radius, int normalColor, int pressColor, int itemTotalSize,
                                                     int itemPosition) {
        StateListDrawable bg = new StateListDrawable();
        Drawable normal = null;
        Drawable pressed = null;
