...
abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    /** TAG(日志) */
    ...
    public enum DIALOG_CATEGORY{
    	CONFIRM_DIALOG,LOADING_DIALOG,TIP_DIALOG,LIST_DIALOG,SHEET_ACTION_DIALOG
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //modify zhangy 20160727 for custom dialog content text too more
        maxHeight = ((dm.heightPixels - StatusBarUtils.getHeight(context))*3)/4;
