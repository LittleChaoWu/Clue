...
public class ActionSheetDialog extends BottomBaseDialog {
    ...
    public ActionSheetDialog setOnItemClickListener(OnItemClickListener listener) {
    ...
    public ActionSheetDialog(Context context, ArrayList<DialogMenuItem> baseItems) {
        this(context, baseItems, null);
    }
     ...
     * 添加字符串数组作为显示内容
     */
    public ActionSheetDialog setDatas(String[] items) {
     ...
     * 添加字符串集合作为显示内容
     */
    public ActionSheetDialog setDatas(ArrayList<String> items) {
        for (String item : items) {
            DialogMenuItem customBaseItem = new DialogMenuItem(item, 0);
            contents.add(customBaseItem);
        }
     ...
     * 添加集合
     */
    public ActionSheetDialog setMenuDatas(ArrayList<DialogMenuItem> items) {
        contents.clear();
    ...
    public ActionSheetDialog showDialog() {
        return (ActionSheetDialog) super.showDialog();
    }
}
