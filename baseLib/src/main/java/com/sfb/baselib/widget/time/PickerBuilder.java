...
public class PickerBuilder {
    ...
    //Required
    public PickerBuilder(Context context, OnTimeSelectListener listener) {
     ...
     */
    public PickerBuilder setType(boolean[] type) {
        mPickerOptions.type = type;
        return this;
    }

    public PickerBuilder setSubmitText(String textContentConfirm) {
        mPickerOptions.textContentConfirm = textContentConfirm;
        return this;
    }

    public PickerBuilder isDialog(boolean isDialog) {
        mPickerOptions.isDialog = isDialog;
        return this;
    }

    public PickerBuilder setCancelText(String textContentCancel) {
        mPickerOptions.textContentCancel = textContentCancel;
        return this;
    }

    public PickerBuilder setTitleText(String textContentTitle) {
        mPickerOptions.textContentTitle = textContentTitle;
        return this;
    }

    public PickerBuilder setSubmitColor(int textColorConfirm) {
        mPickerOptions.textColorConfirm = textColorConfirm;
        return this;
    }

    public PickerBuilder setCancelColor(int textColorCancel) {
    ...
    public PickerBuilder setBgColor(int bgColorWheel) {
        mPickerOptions.bgColorWheel = bgColorWheel;
        return this;
    }

    public PickerBuilder setTitleBgColor(int bgColorTitle) {
        mPickerOptions.bgColorTitle = bgColorTitle;
        return this;
    }

    public PickerBuilder setTitleColor(int textColorTitle) {
        mPickerOptions.textColorTitle = textColorTitle;
        return this;
    }

    public PickerBuilder setSubCalSize(int textSizeSubmitCancel) {
        mPickerOptions.textSizeSubmitCancel = textSizeSubmitCancel;
        return this;
    }

    public PickerBuilder setTitleSize(int textSizeTitle) {
        mPickerOptions.textSizeTitle = textSizeTitle;
        return this;
    }

    public PickerBuilder setContentTextSize(int textSizeContent) {
    ...
    public PickerBuilder setLayoutRes(int res, CustomListener customListener) {
    ...
    public PickerBuilder setRangDate(Calendar startDate, Calendar endDate) {
    ...
    public PickerBuilder setBackgroundId(int backgroundId) {
     ...
     */
    public PickerBuilder setTextColorCenter(int textColorCenter) {
     ...
     * @param textColorOut
     */
    public PickerBuilder setTextColorOut(int textColorOut) {
        mPickerOptions.textColorOut = textColorOut;
        return this;
    }

    public PickerBuilder isCyclic(boolean cyclic) {
        mPickerOptions.cyclic = cyclic;
        return this;
    }

    public PickerBuilder setOutSideCancelable(boolean cancelable) {
        mPickerOptions.cancelable = cancelable;
        return this;
    }

    public PickerBuilder setLunarCalendar(boolean lunarCalendar) {
        mPickerOptions.isLunarCalendar = lunarCalendar;
        return this;
    }


    public PickerBuilder setLabel(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
     ...
     * @return
     */
    public PickerBuilder setTextXOffset(int x_offset_year, int x_offset_month, int x_offset_day,
    ...
    public PickerBuilder isCenterLabel(boolean isCenterLabel) {
     ...
     * @return
     */
    public PickerBuilder setTimeSelectChangeListener(OnTimeSelectChangeListener listener) {
        mPickerOptions.timeSelectChangeListener = listener;
        return this;
    }

    public TimePicker build() {
        return new TimePicker(mPickerOptions);
    }
}
